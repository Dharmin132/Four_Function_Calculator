...
begin
	...
	u1: full_adder port map(x(0),y(0),cin,c0,s(0));
	u2: full_adder port map(x(1),y(1),c0,c1,s(1));
	u3: full_adder port map(x(2),y(2),c1,c2,s(2));
	u4: full_adder port map(x(3),y(3),c2,cout,s(3));
